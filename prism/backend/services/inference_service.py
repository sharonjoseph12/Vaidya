...
class InferenceService:
    ...
    def load_models(self):
        ...
        self.causal_engine = load_causal_explainer()
        self.digital_twin = load_trajectory_model()
    ...
    def run_full_pipeline(
        ...
        patient_features: Optional[dict[Any, Any]] = None,
        ...
        try:
            ...
            # Synthesize final primary diagnosis based on SENSE and Twin
            primary = "TB" if twin.get("without_intervention", [{}])[-1].get("values", {}).get("tb_prob", 0) > 0.5 else "Healthy"

            return {
                "disease_probabilities": sense,
                "uncertainty_bounds": {"TB": [0.65, 0.88], "Anemia": [0.65, 0.78]},
