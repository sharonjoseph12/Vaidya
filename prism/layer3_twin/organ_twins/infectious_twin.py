...
class InfectiousTwin(pl.LightningModule):
    def __init__(self, input_dim=4, latent_dim=16, hidden_dim=32, output_dim=4, lr=1e-3):
        super().__init__()
...
class InfectiousDataModule(pl.LightningDataModule):
    # Stub for infectious disease data module
    def __init__(self, data_dir: str = "prism/data/infectious", batch_size: int = 32):
        super().__init__()
